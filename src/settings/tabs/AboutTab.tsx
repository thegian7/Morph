    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-2">
          Ambient screen border overlay that changes color based on upcoming
          calendar events. Built for people with time blindness.
        </p>
      </div>
      ...
      <section>
        ...
        <p className="text-sm text-gray-600 mb-3">
          Morph is free and open source. If it helps you, consider supporting
          development.
        </p>
        <button
